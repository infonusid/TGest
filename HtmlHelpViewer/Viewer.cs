...
namespace HtmlHelpViewer
{
	...
	public class Viewer : System.Windows.Forms.Form, IHelpViewer
	{
		...
		private void InitializeComponent()
		{
            ...
            this.tabControl1.Size = new System.Drawing.Size(300, 489);
            ...
            this.tabContents.Size = new System.Drawing.Size(292, 463);
            ...
            this.tocTree1.Size = new System.Drawing.Size(292, 463);
            ...
            this.tabIndex.Size = new System.Drawing.Size(292, 463);
            ...
            this.helpIndex1.Size = new System.Drawing.Size(292, 463);
            ...
            this.tabSearch.Size = new System.Drawing.Size(292, 463);
            ...
            this.helpSearch2.Size = new System.Drawing.Size(292, 463);
            ...
            this.panel3.Size = new System.Drawing.Size(451, 489);
            ...
            this.axWebBrowser1.Size = new System.Drawing.Size(451, 489);
		...
		{
            RegistryKey regLocalMachine = null;

            if (Environment.Is64BitOperatingSystem)
            {
                regLocalMachine = RegistryKey.OpenBaseKey(Microsoft.Win32.RegistryHive.LocalMachine, RegistryView.Registry64);
            }
            else
            {
                regLocalMachine = RegistryKey.OpenBaseKey(Microsoft.Win32.RegistryHive.LocalMachine, RegistryView.Registry32);
            }

            //RegistryKey regKey = Registry.LocalMachine.CreateSubKey(LM_Key);
            RegistryKey regKey = regLocalMachine.CreateSubKey(LM_Key);
        ...
        /// <param name="sender">sender of the event</param>
        /// <param name="e">event parameter</param>
        public void miOpen_Click(object sender, System.EventArgs e, string sChmFile)
        {
            //if (openFileDialog1.ShowDialog() == DialogResult.OK)
            //{
                this.Cursor = Cursors.WaitCursor;
                ...
                try
                {
                    ...
                    // open the chm-file selected in the OpenFileDialog
                    _reader.OpenFile(sChmFile, _dmpInfo);
